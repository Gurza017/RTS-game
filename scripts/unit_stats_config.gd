...
const STATS := {
	...
	"big_goblin": {
		"health": BIG_GOBLIN_HP,
		"name_genitive_plural": "больших гоблинов",
		"movement_speed": BIG_GOBLIN_SPEED,
		"attack_1": BIG_GOBLIN_ATTACK,
...
const BIG_GOBLIN_HP_SQUADS := 1.0
const BIG_GOBLIN_HP := 165.0 * BIG_GOBLIN_HORDE_SQUAD * BIG_GOBLIN_HP_SQUADS
...
const BIG_GOBLIN_ATTACK := 10.0 * 3.0
...
const KEEP_VET_UPGRADES := {
	2: {"id": "keep_vet_2", "cost_wood": 400.0, "cost_gold": 1200.0,
		"cost_stone": 200.0, "time": 60.0},
	3: {"id": "keep_vet_3", "cost_wood": 800.0, "cost_gold": 2400.0,
		"cost_stone": 400.0, "time": 90.0},
	4: {"id": "keep_vet_4", "cost_wood": 1600.0, "cost_gold": 4800.0,
		"cost_stone": 800.0, "time": 120.0},
}

...
`qa_target_lock` F2/F4 и `qa_approach_intercept` #2 — плавающие
(перезапустить). **`qa_crowd` C1 проверен A/B (авг. 2026, правка смыкания
...
измеряемых 2.20; `qa_formation` B1/B2,
